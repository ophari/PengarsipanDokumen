        ...
        <form action="{{ route('transaction.incoming.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body row">
                ...
                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                    <x-input-form name="reference_number" :label="__('model.letter.reference_number')" value="123/smk/2023"/>
                </div>
                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                ...
                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                    <div class="mb-3">
                        <label for="attachments" class="form-label">{{ __('Surat') }}</label>
            ...
            <div class="card-footer pt-0">
                <button class="btn bg-primary btn-primary" type="submit">{{ __('menu.general.save') }}</button>
            </div>
        </form>
    </div>
@endsection
