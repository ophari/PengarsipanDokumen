...
@section('content')
    <x-breadcrumb
        ...
        <button
            type="button"
            class="btn bg-primary btn-primary btn-create"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('user.destroy', $user) }}" class="d-inline" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn bg-danger btn-danger btn-sm btn-delete"
                                            type="button">{{ __('menu.general.delete') }}
                                    </button>
                                </form>
                            </td>
                        </tr>
        ...
        <div class="modal-dialog">
            <form class="modal-content" method="post" action="">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn bg-primary btn-primary">{{ __('menu.general.update') }}</button>
                </div>
            </form>
        </div>
    </div>
